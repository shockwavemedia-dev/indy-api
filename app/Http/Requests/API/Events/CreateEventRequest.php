...
final class CreateEventRequest extends BaseRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'shoot_title' => 'string|required|unique:App\Models\Event,shoot_title',
            'start_time' => 'string|nullable',
            'styling_required' => 'string|nullable',
            'shoot_type' => 'array|nullable',
            'shoot_type.*' => [
                'string',
                Rule::in(EventShootTypesEnum::toArray()),
            ],
            'photographer_id' => 'int|nullable|exists:App\Models\Users\AdminUser,id',
        ];
    }
}

...
final class WebEditorDesignatorResolver implements DesignatorResolverInterface
{
    ...
    {
        if ($ticket->getClient()?->getDesignatedWebEditor() === null) {
            return;
        }
    ...
    {
        return $serviceType->getValue() === ServicesEnum::WEBSITE;
    }
}

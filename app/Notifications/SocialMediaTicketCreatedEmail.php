...
final class SocialMediaTicketCreatedEmail extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(mixed $notifiable): MailMessage
    {
        try {
            ...
            $message = \sprintf(
                'Hi %s, % created a Ticket #%s with Social Media Service.',
                $this->user->getFirstName(),
                $this->ticket->getClient()->getName(),

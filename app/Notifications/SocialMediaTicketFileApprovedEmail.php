...
final class SocialMediaTicketFileApprovedEmail extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(mixed $notifiable): MailMessage
    {
        try {
            ...
            $message = \sprintf(
                'Hi %s, %s approved a file in Ticket# %s with Social Media Service.',
